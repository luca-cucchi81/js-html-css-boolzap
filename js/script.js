...
setTimeout(function(){
    var risposta = $('.template2 .speech-bubble-received').clone(); //copia contenuto messaggio inviato che è dentro il template (che è display none)
    risposta.children('.testo-bubble-received').text(messaggioInput); //modif. testo messaggio inviato che e inserimento nel bubble
